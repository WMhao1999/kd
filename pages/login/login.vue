	...
	<view class="content">
		...
		<view class="main" v-if="step==1">
			...
			<view class="password_tips">
				<view @click="register" class="code_login">
					去注册
				</view>
			</view>
			...
			<view class="more_login">
				...
				<view class="more_option">
					<view @click="weixinLogin" class="option cuIcon-weixin"></view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		computed: {
			encryPhoneNum() {
				return encryptedPhoneNumber(this.telNumber)
			}
		}
	};
</script>
